    ...
    <div class="px-4 py-8 sm:py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex flex-col lg:flex-row gap-8 lg:gap-12">
                ...
                <aside class="hidden lg:block lg:w-56 flex-shrink-0 order-2 lg:order-1">
                ...
                <main class="flex-1 min-w-0 order-1 lg:order-2 scroll-mt-24">
                    <section id="our-origins" class="scroll-mt-28 mb-12 first:mt-0 p-8 border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden transition-shadow duration-200 hover:shadow-md bg-white dark:bg-gray-800/50">
                        <h2 class="text-xl font-bold text-gray-900 dark:text-white mb-4 pb-2 border-b border-gray-200 dark:border-gray-600">
                            Our Origins
                        </h2>
                        <p class="text-gray-700 dark:text-white leading-relaxed mb-4">
                    ...
                    <section id="our-mission" class="scroll-mt-28 mb-12 p-8 border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden transition-shadow duration-200 hover:shadow-md bg-white dark:bg-gray-800/50">
                        <h2 class="text-xl font-bold text-gray-900 dark:text-white mb-4 pb-2 border-b border-gray-200 dark:border-gray-600">
                            Our Mission
                        </h2>
                        <p class="text-gray-700 dark:text-white leading-relaxed mb-4">
                    ...
                    <section id="our-process" class="scroll-mt-28 mb-12 p-8 border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden transition-shadow duration-200 hover:shadow-md bg-white dark:bg-gray-800/50">
                        <h2 class="text-xl font-bold text-gray-900 dark:text-white mb-4 pb-2 border-b border-gray-200 dark:border-gray-600">
                            Our Process
                        </h2>
                        <p class="text-gray-700 dark:text-white leading-relaxed mb-4">

        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                <h1 class="text-4xl lg:text-6xl font-bold text-gray-900 dark:text-white mb-6">
                    The Restaurant Website Builder That Works for You
                </h1>
                <p class="text-xl lg:text-2xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                    Stackifide is a simple SaaS platform that lets you create a professional restaurant website in minutes—no coding required. Get found on Google, show up on maps, and grow your business.
                </p>
            </div>
        </div>
    </div>

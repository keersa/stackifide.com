        ...
        <div class="py-8 md:py-12 px-4 sm:px-6 lg:px-8">
            <div class="max-w-4xl mx-auto">
                ...
                <div class="text-center mb-8 md:mb-12">
                    <div class="inline-flex items-center justify-center w-16 h-16 md:w-20 md:h-20 bg-gradient-to-br from-blue-600 to-cyan-600 rounded-2xl mb-4 shadow-lg transform hover:scale-105 transition-transform duration-300">
                    ...
                    <p class="text-lg md:text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
                        Tell us about your restaurant and we'll help you create a powerful online presence with advanced features
                    </p>
                </div>

                <form method="POST" action="{{ route('pro.store') }}" class="space-y-6 md:space-y-8">
                    @csrf
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-6">
                                <div class="md:col-span-2">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="text" 
                                               ...
                                               class="block w-full pl-10 pr-3 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-600 focus:border-blue-600 dark:bg-gray-700 dark:text-white transition-all">
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <select name="business_type" 
                                                id="business_type"
                                                class="block w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-600 focus:border-blue-600 dark:bg-gray-700 dark:text-white appearance-none bg-white dark:bg-gray-700 transition-all">
                                ...
                                <div>
                                    ...
                                    <input type="text" 
                                           ...
                                           class="block w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-600 focus:border-blue-600 dark:bg-gray-700 dark:text-white transition-all">
                                </div>
                                <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-6">
                                <div>
                                    ...
                                    <input type="text" 
                                           ...
                                           required
                                           placeholder="John"
                                           class="block w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 dark:bg-gray-700 dark:text-white transition-all">
                    ...
                    <!-- Submit Section -->
                    <div class="bg-gradient-to-r from-blue-600 to-cyan-600 rounded-2xl shadow-2xl p-6 md:p-8">
                        <div class="flex flex-col sm:flex-row justify-between items-center gap-4">
                            <div class="text-white">
                                <p class="text-lg font-semibold mb-1">Ready to get started?</p>
                                <p class="text-sm text-blue-100">We'll review your information and contact you within 24 hours.</p>
                            </div>
                            <div class="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
                                ...
                                <button type="submit" 
                                        class="inline-flex justify-center items-center px-8 py-3 bg-white text-blue-600 hover:bg-blue-50 font-bold rounded-lg shadow-lg transition-all duration-200 transform hover:scale-105 hover:shadow-xl">

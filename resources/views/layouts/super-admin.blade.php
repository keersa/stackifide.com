                        ...
                        <div class="flex justify-between items-center h-14 sm:h-16 gap-2 min-w-0">
                            ...
                            <div class="flex items-center gap-2 min-w-0 flex-1">
                                <button @click="sidebarOpen = !sidebarOpen"
                                        type="button"
                                        class="lg:hidden p-2 rounded-md text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-purple-500 shrink-0"
                                ...
                                @isset($header)
                                    <h1 class="text-base sm:text-xl font-semibold text-gray-900 dark:text-gray-100 truncate">
                                        {{ $header }}
                                    </h1>
                                @endisset
                            </div>
                            ...
                            <div class="flex items-center gap-1 sm:gap-4 shrink-0">
                                ...
                                <div class="hidden sm:block text-sm text-gray-700 dark:text-gray-300 truncate max-w-[120px] md:max-w-none">

...
<aside class="w-64 bg-gray-800 dark:bg-gray-800 min-h-screen" aria-label="Sidebar">
    <div class="h-full px-3 py-4 overflow-y-auto">
        ...
        <ul class="space-y-2 font-medium">
            ...
            @if($currentWebsite)
            <div class="border border-gray-700 dark:border-black text-md font-semibold text-white bg-gray-900 dark:bg-gray-700">
                <div class="px-4 py-2 text-lg bg-gray-700 dark:bg-black">
                    <a href="{{ route('admin.websites.show', $currentWebsite) }}" class="text-purple-400 dark:text-purple-400 hover:text-white dark:hover:text-gray-100">
                        {{ $currentWebsite->name }}
                    </a>
                </div>
                <ul class="bg-gray-900 dark:bg-gray-900 text-white dark:text-gray-200">
                    <li>
                        <a href="{{ route('admin.websites.edit', $currentWebsite) }}" 
                        class="flex items-center p-2 {{ (request()->routeIs('admin.websites.edit')) && optional(request()->route('website'))->id === $currentWebsite->id ? 'bg-gray-600 text-white' : 'text-white dark:text-gray-200 hover:bg-gray-700 hover:text-white' }} transition">
                            <svg class="w-5 h-5 me-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <li>
                        ...
                        class="flex items-center p-2 {{ request()->routeIs('admin.websites.hours.*') && optional(request()->route('website'))->id === $currentWebsite->id ? 'bg-indigo-600 text-white' : 'text-white dark:text-gray-200 hover:bg-gray-700 hover:text-white' }} transition">
                            <svg class="w-5 h-5 me-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <li>
                        ...
                        class="flex items-center p-2 {{ request()->routeIs('admin.websites.menu.*') && optional(request()->route('website'))->id === $currentWebsite->id ? 'bg-indigo-600 text-white' : 'text-white dark:text-gray-200 hover:bg-gray-700 hover:text-white' }} transition">
                            <svg class="w-5 h-5 me-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <li>
                        ...
                        class="flex items-center p-2 {{ request()->routeIs('admin.websites.pages.*') && optional(request()->route('website'))->id === $currentWebsite->id ? 'bg-indigo-600 text-white' : 'text-white dark:text-gray-200 hover:bg-gray-700 hover:text-white' }} transition">
                            <svg class="w-5 h-5 me-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <li>
                        ...
                        class="flex items-center p-2 {{ request()->routeIs('admin.websites.images.*') && optional(request()->route('website'))->id === $currentWebsite->id ? 'bg-indigo-600 text-white' : 'text-white dark:text-gray-200 hover:bg-gray-700 hover:text-white' }} transition">
                            <svg class="w-5 h-5 me-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">

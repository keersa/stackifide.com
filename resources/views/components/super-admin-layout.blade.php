                        ...
                        <div class="flex justify-between items-center h-14 sm:h-16 gap-2 min-w-0">
                            ...
                            <div class="flex items-center gap-2 min-w-0 flex-1">
                                <button @click="sidebarOpen = !sidebarOpen"
                                        type="button"
                                        class="lg:hidden p-2 rounded-md text-purple-200 hover:text-white hover:bg-purple-800 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-purple-400 shrink-0"
                                ...
                                @if($header)
                                    <h1 class="text-base sm:text-xl font-semibold text-white truncate">
                                        {{ $header }}
                                    </h1>
                                @endif
                            </div>
                            ...
                            <div class="flex items-center gap-1 sm:gap-4 shrink-0">
                                ...
                                <div class="hidden sm:block text-sm text-white truncate max-w-[120px] md:max-w-none">
                                    <span class="truncate">{{ Auth::user()->full_name }}</span>
                                    <span class="text-purple-200">(Super Admin)</span>
                                </div>

...
<aside class="w-64 bg-purple-900 dark:bg-purple-950 min-h-screen" aria-label="Sidebar">
    <div class="h-full px-3 py-4 overflow-y-auto">
        ...
        <ul class="space-y-2 font-medium">
            ...
            <!-- FAQs -->
            <li>
                <a href="{{ route('super-admin.faqs.index') }}" 
                   class="flex items-center p-2 rounded-lg {{ request()->routeIs('super-admin.faqs.*') ? 'bg-purple-700 text-white' : 'text-purple-200 hover:bg-purple-800 hover:text-white' }} transition">
                    <svg class="w-5 h-5 me-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">

<x-admin-layout>
    <x-admin-website-header :website="$website" title="Manage Logos" />
    ...
    x-init="$watch('activeTab', val => localStorage.setItem('last_logo_tab_{{ $website->id }}', val))">
        ...
        <div class="px-2 flex items-center justify-between">
            <h3 class="font-black text-gray-900 dark:text-white text-2xl tracking-tighter">{{ __('Manage Logos') }}</h3>
        </div>

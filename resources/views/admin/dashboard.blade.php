                ...
                <div class="p-6 text-gray-900">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-sm text-gray-600">You are logged in as an Administrator</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <p class="text-sm font-medium text-gray-500">Customer Websites</p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <a href="{{ route('dashboard') }}" class="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500">View standard user dashboard</p>
                            </div>
                        </a>

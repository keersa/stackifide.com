            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <a href="{{ route('admin.leads.index') }}" class="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition">
                            ...
                            <div>
                                <p class="font-medium text-gray-900">Leads</p>
                                <p class="text-sm text-gray-500">Manage restaurant leads and clients</p>
                            </div>
                        </a>

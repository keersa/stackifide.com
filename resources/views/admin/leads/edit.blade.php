                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" 
                                       ...
                                       id="restaurant_name"
                                       value="{{ old('restaurant_name', $lead->restaurant_name) }}"
                                       required
                            ...
                            <div>
                                ...
                                <input type="number" 
                                       ...
                                       value="{{ old('number_of_locations', $lead->number_of_locations) }}"
                                       min="1"
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="special_requirements" 
                                          ...
                                          rows="3"
                                          class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">{{ old('special_requirements', $lead->special_requirements) }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="date" 
                                       ...
                                       value="{{ old('first_contact_date', $lead->first_contact_date?->format('Y-m-d')) }}"
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                            </div>
                            <div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="text" 
                                       name="tags" 
                                       id="tags"
                                       value="{{ old('tags', is_array(old('tags')) ? implode(', ', old('tags')) : (is_array($lead->tags) ? implode(', ', $lead->tags) : (is_string($lead->tags) ? $lead->tags : ''))) }}"
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <textarea name="notes" 
                                          id="notes"
                                          rows="4"
                                          class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">{{ old('notes', $lead->notes) }}</textarea>
                            ...
                            <div>
                                ...
                                <textarea name="internal_notes" 
                                          id="internal_notes"
                                          rows="4"
                                          class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">{{ old('internal_notes', $lead->internal_notes) }}</textarea>

<x-super-admin-layout>
    ...
    <div>
            <form method="POST" action="{{ route('super-admin.leads.update', $lead) }}" class="space-y-6">
                @csrf
                @method('PUT')
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <textarea name="notes" 
                                          id="notes"
                                          rows="4"
                                          class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-purple-500 focus:ring-purple-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">{{ old('notes', $lead->notes) }}</textarea>

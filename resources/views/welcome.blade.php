        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div id="pricing" class="grid grid-cols-1 lg:grid-cols-3 gap-4 px-4 lg:px-0 mx-auto max-w-7xl text-center">
                ...
                <div class="relative bg-gray-100 dark:bg-gray-800 pt-8 pb-24 lg:pb-8 px-4 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
                    ...
                    <ul class="space-y-1.5 text-left mb-24">
                        <li class="flex items-start gap-3 text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-900 py-2 px-4 mb-1 rounded-lg">
                            <svg class="w-5 h-5 text-purple-500 dark:text-purple-400 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                            </svg>
                            <span>Premium Website</span>
                        </li>
                ...
                <div class="relative bg-gradient-to-b from-purple-50 to-blue-50 dark:from-gray-800 dark:to-gray-900 pt-8 pb-24 lg:pb-8 px-4 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 border-2 border-purple-200/60 dark:border-purple-800/40 overflow-hidden">
                    ...
                    <div class="absolute top-10 right-10">
                        <span class="block bg-purple-500 dark:bg-purple-600 text-white text-sm font-bold py-2 px-12 text-center shadow-md transform rotate-45 translate-x-1/2 -translate-y-1/2 origin-center">
                            Built for You
                        </span>
                    </div>
                    <h2 class="text-4xl font-bold text-gray-800 dark:text-gray-200 mb-1">Custom</h2>
                    <h3 class="mb-4 font-bold text-3xl text-purple-700 dark:text-purple-400 mb-4">When You Need Custom</h3>
                    ...
                    <div class="absolute bottom-5 left-0 right-0 grid grid-cols-1 gap-4 mt-8 px-4">
                        <a href="{{ route('partner.get-started') }}" class="bg-purple-600 hover:bg-gray-700 dark:bg-purple-600 dark:hover:bg-purple-500 p-3 text-xl font-black text-center rounded-xl text-white border-2 border-purple-700 dark:border-purple-500 shadow-lg hover:shadow-xl transition-all hover:scale-[1.02] duration-200">

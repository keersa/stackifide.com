...
class BasicController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        $leadData = array_merge($validated, [
            ...
            'tags' => ['Basic Plan', 'Website Inquiry'],
        ]);
        ...
        return redirect()->route('basic.get-started')
            ->with('success', 'Thank you for your inquiry! We will contact you soon to discuss your new website.');
    }
